...
      en: "Fetch up to 100 images from Pinterest using Google CSE"
...
        return api.sendMessage("No photo found!", event.threadID);
...
        return api.sendMessage("There was a problem", event.threadID);
