...
module.exports.config = {
  name: "jann",
  aliases: ["jann","জান", "januu", "hakari", "Yuri"],
  version: "1.7",
  author: "MahMUD",
  countDown: 0,
  role: 0,
...
module.exports.onStart = async ({ api, event, args, usersData }) => {
  try {
    ...
    if (!args[0]) {
      const responses = ["𝐛𝐨𝐥𝐨 𝐣𝐚𝐧🧸", "𝐛𝐨𝐥𝐨 𝐛𝐚𝐛𝐲🦋", "𝐡𝐞𝐥𝐥𝐨 𝐛𝐚𝐛𝐲🎀", "𝐇𝐮𝐦𝐦 𝐛𝐨𝐥𝐨😗🤌","𝑯𝒖𝒎𝒎 𝒂𝒎𝒓 𝒋𝒂𝒏 𝒕𝒂 𝒌𝒂𝒏𝒐 𝒅𝒂𝒌𝒆🙈","𝑲𝒊 𝒉𝒐𝒊𝒔𝒆 𝒌𝒐😒"];
    ...
    if (args[0] === "edit") {
      const allowedUserID = "100030451953891";
