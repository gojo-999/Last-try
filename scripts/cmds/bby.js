...
module.exports = {
  ...
  onChat: async function ({ api, event }) {
    const randomReplies = ["𝐁𝐨𝐥𝐨 𝐣𝐚𝐧 𝐤𝐢 𝐤𝐨𝐫𝐭𝐞 𝐩𝐚𝐫𝐢 𝐭𝐦𝐫 𝐣𝐨𝐧𝐧𝐨🥹","𝐆𝐚𝐣𝐚 𝐤𝐡𝐚 𝐦𝐚𝐧𝐮𝐬𝐡 𝐡𝐨 🍁🤡","আম গাছে আম নাই ঢিল কেন মারো, তোমার সাথে প্রেম নাই বেবি কেন ডাকো 😒🐸","𝐇𝐢𝐥𝐥𝐰 𝐣𝐚𝐧𝐮𝐮🙈💋","𝐁𝐛𝐲🌹𝐑𝐨𝐬𝐞 𝐍𝐢𝐚 𝐚𝐬𝐨 𝐩𝐥𝐳𝐳𝐳𝐳🦋","𝑨𝒓𝒆 𝒋𝒂𝒏𝒏 𝒂𝒕𝒐 𝒅𝒂𝒌𝒐 𝒌𝒂𝒏𝒐 𝒕𝒖𝒎𝒓 𝒌𝒂𝒋 𝒏𝒂𝒊","𝑨𝒓𝒆 𝑨𝒕𝒂 𝒕𝒐 𝒂𝒎𝒓 𝒃𝒃𝒚","দূরে যা, তোর কোনো কাজ নাই, শুধু 𝗯𝗯𝘆 𝗯𝗯𝘆 করিস 🐸","𝐀𝐦𝐚𝐤𝐞 𝐞𝐭𝐨 𝐧𝐚 𝐝𝐞𝐤𝐞 𝐚𝐦𝐫 𝐛𝐨𝐬𝐬 𝐌𝐚𝐡𝐢𝐧 𝐤𝐞 𝐞𝐤𝐭𝐚 𝐠𝐨𝐟 𝐝𝐞 😾","𝐄𝐭𝐨 𝐛𝐚𝐛𝐲 𝐛𝐚𝐛𝐲 𝐤𝐨𝐫𝐨𝐬𝐡 𝐤𝐢𝐥𝐥𝐚𝐢 😒","𝗔𝗺𝗿 𝗯𝗼𝘀𝘀 𝗷𝗲 𝘀𝗶𝗻𝗴𝗹𝗲 𝗰𝗵𝗼𝗸𝗲 𝗽𝗼𝗿𝗲 𝗻𝗮 𝘁𝗼𝗿 😒","𝕂𝕚 𝕜𝕠𝕓𝕚 𝕜𝕠 𝕥𝕠𝕣 𝕛𝕠𝕟𝕟𝕠𝕚 𝕓𝕠𝕤𝕖 𝕒𝕔𝕙𝕚 😒","𝐇𝐚𝐫𝐚𝐦𝐣𝐚𝐝𝐢 𝐛𝐨𝐥 𝐤𝐢 𝐛𝐨𝐥𝐛𝐢 🙈","𝐀𝐦𝐫 𝐛𝐨𝐬𝐬 𝐞𝐫 𝐢𝐝 𝐛𝐨𝐬𝐬 𝐤𝐢𝐧𝐭𝐮 𝐬𝐢𝐧𝐠𝐥𝐞 https://www.facebook.com/mdmahin.2026cr7wc","বার বার ডাকলে মাথা গরম হয় কিন্তু 😒","𝐁𝐨𝐥𝐨 𝐛𝐞𝐟𝐲 𝐤𝐢 𝐛𝐨𝐥𝐛𝐚 😭","𝙑𝙝𝙪𝙡𝙚 𝙟𝙖𝙬 𝙖𝙢𝙖𝙠𝙚 😞","𝗔𝗺𝗿 𝗯𝗼𝘀𝘀 𝐌𝐚𝐡𝐢𝐧 𝗲𝗿 𝗺𝗼𝗻 𝗸𝗵𝗮𝗿𝗮𝗽 𝗯𝗼𝘀𝘀 𝗲𝗿 𝗴𝗼𝗳 𝗻𝗮𝗶 😿"," তুই কালকে দেখা করিস তো একটু 😈","𝗮𝘀𝘀𝗮𝗹𝗮𝗺𝘂𝗹𝗮𝗶𝗸𝘂𝗺🥳🥳","ইস যদি কোনো মেয়ে আমাকে একা পেয়ে খেয়ে দিতো..!🥺🙂","𝐌𝐚𝐡𝐢𝐧 𝐫𝐞 𝐝𝐚𝐤🙈𝐨𝐫 𝐬𝐚𝐭𝐞 𝐩𝐫𝐞𝐦 𝐤𝐨𝐫𝐢","𝐊𝐢 𝐡𝐨𝐢𝐬𝐞 𝐣𝐚𝐧𝐮𝐮😘","𝐓𝐮𝐦𝐚𝐫 𝐤𝐚𝐣 𝐧𝐚𝐢 𝐧𝐡 𝐬𝐡𝐮𝐝𝐮 𝐚𝐦𝐚𝐤𝐞 𝐝𝐚𝐤𝐨🙈","𝐉𝐨𝐝𝐢 𝐇𝐮𝐛𝐛𝐲 𝐥𝐚𝐠𝐞 𝐬𝐨𝐦𝐦𝐬𝐚 𝐧𝐚𝐢 𝐚𝐦𝐫 𝐛𝐨𝐬𝐬 𝐚𝐜𝐡𝐞𝐞 𝐞𝐞 𝐭𝐨𝐨💋","𝐋𝐨𝐨𝐤 𝐚𝐭 𝐭𝐡𝐞 𝐬𝐤𝐲 𝐢𝐬𝐧'𝐭 𝐢𝐬 𝐯𝐞𝐫𝐲 𝐜𝐮𝐭𝐞 𝐣𝐚𝐧𝐧🍷","𝐛𝐛𝐲 𝐓𝐚𝐤𝐚 𝐃𝐞𝐰 🙈","𝙰𝚌𝚑𝚑𝚊 𝚋𝚋𝚢 𝚝𝚞𝚖𝚒 𝚔𝚒𝚑 𝚊𝚖𝚊𝚒 𝚟𝚊𝚕𝚘𝚋𝚊𝚜𝚘","𝙸 𝚕𝚘𝚟𝚎 𝚢𝚘𝚞 𝚋𝚋𝚢💋","𝕮𝖍𝖔𝖈𝖔𝖑𝖆𝖙𝖊 𝖐𝖆𝖜 𝖆𝖒𝖗 𝖇𝖔𝖘𝖘 𝖊𝖗 𝖌𝖈 𝖙𝖊 𝖏𝖔𝖎𝖓 𝖍𝖔𝖚😛","𝐔𝐦𝐚𝐡𝐡𝐡𝐡𝐡𝐡𝐡𝐡𝐡𝐡 𝐛𝐛𝐲𝐲𝐲𝐲𝐲𝐲💋💋"];
